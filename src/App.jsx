...
function App() {
  return (
    <>
        ...
        <div className='p-4 lg:mb-10'>
          <a href='https://www.instagram.com/cooperativadinamica/'>
            <div className='px-5 p-12 flex  items-center  flex-col   bg-laranja rounded-3xl lg:flex-row sm:justify-center lg:px-10 lg:mr-5'>
              <h1 className='text-white text-3xl m-4 font-semibold md:text-3xl w-auto lg:w-2/5 text-wrap'>
                Acesse nossas
      ...
      <div className='flex flex-col gap-10 lg:gap-32 px-2 pb-10 lg:pr-8 pt-10'>
        <Explain
