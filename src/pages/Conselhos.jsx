...
export default function Conselhos() {
    return (
        <div className="font-nunitoSans">
            ...
            <div className="flex justify-center items-center md:p-4 lg:px-10 2xl:px-2">
            ...
            <section className="flex flex-col gap-8 bg-zinc-100 sm:px-20 pb-10">
                <div className="flex flex-col  justify-center p-6 pt-8 bg-zinc-100 text-zinc-800  lg:px-24 xl:flex-row sm:gap-10 lg:border-b lg:border-zinc-300 lg:pb-20">
                    ...
                    <img src={Persons} alt="persons" className="block lg:hidden lg:h-60" />
                    ...
                    <img src={Persons} alt="persons" className="hidden xl:block lg:h-60" />
                </div>
                <div className="flex flex-col  justify-center p-6 pt-8 bg-zinc-100 text-zinc-800 lg:px-24 xl:flex-row sm:gap-10 lg:border-b lg:border-zinc-300 lg:pb-20">
                    <img src={Folder} alt="persons" className="hidden lg:block xl:hidden lg:h-60" />
                    <img src={Folder} alt="persons" className="block lg:hidden lg:h-60" />
                    <div className="flex flex-col">
                    ...
                    <img src={Folder} alt="persons" className="hidden xl:block lg:h-60" />
                </div>
                <div className="flex flex-col  justify-center p-6 pt-8 bg-zinc-100 text-zinc-800 lg:px-24 xl:flex-row sm:gap-10">
                    ...
                    <img src={Analitc} alt="persons" className="block lg:hidden lg:h-60" />
                    <div className="flex flex-col">
