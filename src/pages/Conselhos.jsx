...
export default function Conselhos() {
    return (
        <>
            ...
            <section className="flex flex-col gap-4 bg-zinc-100 sm:px-20">
                <div className="flex flex-col  justify-center p-6 pt-8 bg-zinc-100 text-zinc-800 md:flex-row sm:gap-10">
