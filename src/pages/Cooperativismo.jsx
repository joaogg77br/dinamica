...
export default function Cooperativismo() {
    return (
        <>
            ...
            <section className="flex  justify-center items-center gap-4 flex-col p-4 md:px-20 bg-zinc-100">
                <div className="relative bg-white p-4 rounded-2xl pl-20 lg:p-10 lg:pl-32">
                    <div className="absolute w-5 top-0 left-0 rounded-l-3xl bg-orange-500 h-full lg:w-10"></div>
                    <div className="text-zinc-700">
                        <h1 className="font-medium text-3xl p-2 pb-4 text-orange-500 ">Cooperativismo</h1>
                ...
                <div className="relative bg-white p-4 rounded-2xl pl-20 lg:p-10 lg:pl-32">
                    ...
                    <div className="text-zinc-700">
                        <h1 className="font-medium text-3xl p-2 pb-4 text-green-800 ">Cooperativa</h1>
                ...
                <div className="relative bg-white p-4 rounded-2xl pl-20 lg:p-10 lg:pl-32">
                    ...
                    <div className="text-zinc-700">
                        <h1 className="font-medium text-3xl p-2 pb-4 text-zinc-400 ">Cooperado</h1>
