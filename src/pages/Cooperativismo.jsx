...
export default function Cooperativismo() {
    return (
        <div className="font-nunitoSans">
            <Scrolltop />
            <div className="sm:px-20 lg:px-52 2xl:px-80">
                <Header />
                <Info Title={"Cooperativismo, Cooperativa e Cooperado"} />
            </div>

            <section className="flex  justify-center items-center gap-4 flex-col p-4 md:px-20 lg:px-52 2xl:px-80 bg-zinc-100 md:py-20 lg:pb-20">
