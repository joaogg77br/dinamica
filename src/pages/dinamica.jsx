    ...
    return (
        <div className="font-nunitoSans">
            ...
            <section className=" flex justify-center items-center">
                <div className="flex flex-col justify-center lg:py-10 sm:items-center lg:items-start lg:flex-row gap-4 bg-cinza lg:p-10  lg:px-40 2xl:px-80 w-full md:pt-10 md:pb-10">
