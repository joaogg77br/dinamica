                ...
                <div className="flex flex-col text-xl font-medium">
                    ...
                    <div className="flex justify-end flex-col items-end">
                        ...
                        <div className="flex w-full rounded-br-2xl rounded-tl-2xl p-4  bg-white">
                            ...
                            <p className="text-2xl p-8 w-2/4">Gestão Democrática e Livre</p>
                        </div>
                    </div>
                    <div className="flex justify-end flex-col items-start">
                        ...
                        <div className="flex text-2xl w-full rounded-tr-2xl rounded-bl-2xl p-4 bg-white">
                            ...
                            <p className="text-2xl p-8 w-2/4">Participação Econômica dos Cooperados</p>
                        </div>
                    </div>
                    <div className="flex justify-end flex-col items-end">
                        ...
                        <div className="flex  text-2xl w-full rounded-tr-2xl rounded-bl-2xl p-4 bg-white">
                            ...
                            <p className="text-2xl p-8 w-2/4">Autonomia e Independência</p>
                        </div>
                    </div>
                    <div className="flex justify-end flex-col items-start">
                        ...
                        <div className="flex w-full rounded-tr-2xl rounded-bl-2xl p-4 bg-white">
                            ...
                            <p className="text-2xl p-8 w-2/4">Educação, Formação e Informação</p>
                        </div>
                    </div>
                    <div className="flex justify-end flex-col items-end">
                        <div className="flex justify-center p-4 bg-orange-500 w-16 text-white">6</div>
                        <div className="flex w-full rounded-tr-2xl rounded-bl-2xl p-4 bg-white">
                            <img src={People} alt=""  className="2/4"/>
                            <p className="text-2xl p-8 w-2/4">Intercoo-peração</p>
                        </div>
                    </div>
                    <div className="flex justify-end flex-col items-start">
                        ...
                        <div className="flex w-full rounded-tr-2xl rounded-bl-2xl p-4 bg-white">
                            ...
                            <p className="text-2xl p-8 w-2/4">Interesse Pela Comunidade</p>
                        </div>
                    </div>
                </div>
            </section>
