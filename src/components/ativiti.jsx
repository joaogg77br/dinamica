...
export default function Ativiti({Txt,imagem}){
    return(
        <>
                <div className="w-56 h-48 flex flex-col  text-sm font-medium gap-4 justify-center items-center bg-white text-center p-8 rounded-2xl lg:w-60 lg:h-44 text-zinc-800">
