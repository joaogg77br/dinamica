...
export default function LastNews() {
  return (
    ...
    <div className="w-full bg-zinc-100 p-4 md:px-20 lg:px-64 2xl:px-80 py-20">
      <div className="w-48">
      ...
      <main className="flex flex-col items-center justify-center lg:flex-row gap-5 lg:pr-44 md:px-20 lg:px-40 w-full bg-zinc-100  py-10 
          2xl:gap-16
        ">
