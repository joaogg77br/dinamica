...
export default function LastNews(){
    return(
        ...
        <div className="w-full bg-zinc-100 p-4 md:px-20 lg:px-44">
          <Link to="/noticias">
           <p className="flex gap-2 text-white  p-2 rounded-2xl duration-300 justify-center bg-laranja w-48 border-2 border-laranja hover:bg-white hover:text-laranja 2xl:mx-6 ">Ultimas nóticias <ChevronRight/></p> 
          </Link>
        <main className="flex flex-col items-center justify-center lg:flex-row gap-5 lg:gap-10 lg:pr-44 md:px-20 lg:px-40 w-full bg-zinc-100  py-10 2xl:gap-10">
